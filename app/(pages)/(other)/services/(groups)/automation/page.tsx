...
export const metadata: Metadata = {
  title: 'Services - Automation Solutions by Oz Smart Home',
  ...
  return (
    <ContentWrapper className="relative  z-20 bg-black mx-4 my-4 px-8 lg:px-0 py-12 lg:py-16 ">
      <div className="relative text-white z-20 text-lg w-full max-w-2xl mx-auto">
        ...
        <span className="mb-4 block text-md font-rhd">Know more about our automation, scene and routines solutions</span>
      </div>
    </ContentWrapper>
  );
}
