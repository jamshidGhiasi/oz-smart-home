...
export const metadata: Metadata = {
  title: 'Services - Home Entertainment Solutions by Oz Smart Home',
  ...
  return (
    <ContentWrapper className="relative  z-20 bg-black mx-4 my-4 px-8 lg:px-0 py-12 lg:py-16 ">
      <div className="relative text-white z-20 text-lg w-full max-w-2xl mx-auto">
        <h1 className='text-2xl sm:text-2xl md:text-3xl lg:text-4xl mb-1 mt-0 text-left text-white'> <span className='sub-heading'>Entertainemtn, Home Theater & AV</span></h1>
        <span className="mb-4 block text-md font-rhd">Know more about our home entertainment solutions</span>
      </div>
    </ContentWrapper>
  );
}
