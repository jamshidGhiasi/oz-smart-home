  ...
  return (
    ...
    <ContentWrapper className="relative  z-20 bg-black mx-4 my-4 px-8 lg:px-0 py-12 lg:py-16 ">
      <div className="relative text-white z-20 text-lg w-full max-w-2xl mx-auto">
        ...
        <span className="mb-4 block text-md font-rhd">See Smart Home Solutions</span>
      </div>

      <div className="relative text-white z-20 text-lg w-full max-w-2xl mx-auto">

        <h2 className="sticky md:sticky lg:static top-[64px] bg-black py-2">Smart Lighting</h2>
        ...
        <h2 className="sticky md:sticky lg:static top-[64px] bg-black py-2">Smart Blinds and Curtains</h2>
        ...
        <h2 className="sticky md:sticky lg:static top-[64px] bg-black py-2">Smart Air Conditioning:</h2>
        ...
        <h2 className="sticky md:sticky lg:static top-[64px] bg-black py-2">Access and Intercom:</h2>
        ...
        <h2 className="sticky md:sticky lg:static top-[64px] bg-black py-2">CCTV - Security & Alarm:</h2>
        ...
        <h2 className="sticky md:sticky lg:static top-[64px] bg-black py-2">Home Entertainment:</h2>
        ...
        <h2 className="sticky md:sticky lg:static top-[64px] bg-black py-2">Home Network</h2>
        ...
        <h2 className="sticky md:sticky lg:static top-[64px] bg-black py-2">Automation:</h2>
